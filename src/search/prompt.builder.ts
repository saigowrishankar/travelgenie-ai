// src/search/prompt.builder.ts

// Full prompt — used on first attempt
export function buildTravelPrompt(destination: string): string {
...
// Shorter fallback prompt — used if first attempt returns truncated JSON
export function buildShortTravelPrompt(destination: string): string {
